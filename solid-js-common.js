...
function startTransition(fn, cb) {
  ...
  queueMicrotask(() => {
    ...
    batch(fn);
    if (!Scheduler && !SuspenseContext && cb)
      cb();
  });
}
...
function Suspense(props) {
  let counter2 = 0, showContent, showFallback;
...
let DEV;
var solid = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  $PROXY,
  DEV,
  ErrorBoundary,
...
export {$PROXY as $, createUniqueId as A, enableScheduling as B, equalFn as C, DEV as D, ErrorBoundary as E, For as F, from as G, indexArray as H, Index as I, lazy as J, mapArray as K, observable as L, Match as M, on as N, onError as O, onMount as P, requestCallback as Q, runWithOwner as R, Show as S, startTransition as T, useContext as U, useTransition as V, createMemo as a, createRoot as b, createComponent as c, createRenderEffect as d, createSignal as e, splitProps as f, Suspense as g, SuspenseList as h, Switch as i, getOwner as j, getListener as k, batch as l, mergeProps as m, solid as n, onCleanup as o, awaitSuspense as p, cancelCallback as q, children as r, sharedConfig as s, createComputed as t, untrack as u, createContext as v, createDeferred as w, createEffect as x, createResource as y, createSelector as z};
export default null;
